...
(function() {
  ...
  this.NumericLiteral = (function(_super) {
    ...
    NumericLiteral.name = 'NumericLiteral';
  ...
  this.PostfixExpression = (function(_super) {
    ...
    PostfixExpression.name = 'PostfixExpression';
  ...
  this.VariableStatement = (function(_super) {
    ...
    VariableStatement.name = 'VariableStatement';
  ...
  this.DoWhileStatement = (function(_super) {
    ...
    DoWhileStatement.name = 'DoWhileStatement';
  ...
  this.ForStatement = (function(_super) {
    ...
    ForStatement.name = 'ForStatement';
  ...
  this.ContinueStatement = (function(_super) {
    ...
    ContinueStatement.name = 'ContinueStatement';
