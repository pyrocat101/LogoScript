...
(function() {
  var Canvas, Turtle, deg2rad, fs, getMathFuncs, rad2deg;
  ...
  Turtle = (function() {
    ...
    function Turtle(options) {
      ...
      if ((options.width != null) && (options.height != null)) {
        this._canvas = new Canvas(options.width, options.height);
      } else {
        this._canvas = new Canvas(400, 400);
      }
      this._ctx = this._canvas.getContext('2d');
      this._output = (_ref = options.output) != null ? _ref : 'output.png';
      if (options.antilias !== false) {
        this._ctx.antilias = 'none';
      }
      this._ctx.save();
      this._ctx.fillStyle = 'white';
      this._ctx.fillRect(0, 0, this._canvas.width, this._canvas.height);
      this._ctx.restore();
      this._ctx.setTransform(1, 0, 0, -1, this._canvas.width / 2, this._canvas.height / 2);
    ...
    Turtle.prototype.drawImage = function(path) {
      var out, stream;
